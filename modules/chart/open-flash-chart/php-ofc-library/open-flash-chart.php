	...
	*/
	...
	function render()
	{
		...
		if($this->output_type == 'js')
		{
			...
			$tmp[] = '<script type="text/javascript" src="/modules/chart/open-flash-chart/' . $this->js_path . 'swfobject.js"></script>';
			$tmp[] = '<script type="text/javascript">';
			$tmp[] = 'var so = new SWFObject("/modules/chart/open-flash-chart/open-flash-chart.swf", "ofc", "'. $this->width . '", "' . $this->height . '", "9", "#FFFFFF");';
