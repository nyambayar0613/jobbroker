        ...
        <tr>
            <td style="background-image:url('./img/boxbg589.gif')" align="center">
                <table width="551" cellspacing="0" cellpadding="16">
                    <tr style="height:17px">
                        <td style="background-image:url('./img/ttbg551.gif');border:0px " class="white">
                            <span class="bold big">[매입요청]</span> 이 페이지는 결제건에 대해 매입을 요청하는 샘플(예시) 페이지입니다.
                        </td>
                    </tr>
                    <tr>
                        <td style="background-image:url('./img/boxbg551.gif') ;">
                            <p class="align_left">소스 수정시 소스 안에 <span class="red bold">※ 주의 ※</span>표시가 포함된 문장은
                            가맹점의 상황에 맞게 적절히 수정 적용하시길 바랍니다.</p>
                            <p class="align_left">결제된 건에 대한 매입을 요청하는 페이지 입니다. <br/>
                                <span class="red">이 페이지는 KCP에 수동매입 가맹점으로 등록된 경우에만 사용합니다.<br/>
                                수동매입 가맹점인 경우에만 사용하시기 바랍니다.
                                </span>
                            </p>
                            <p class="align_left">
                            결제가 승인되면 결과값으로 KCP 거래번호(tno)값을 받으실 수 있습니다.<br/>
                            가맹점에서는 이 KCP 거래번호(tno)값으로 매입요청을 하실 수 있습니다.</p>
                        </td>
                    </tr>
                ...
                <table width="527" cellspacing="0" cellpadding="0" class="margin_top_20">
                    <tr><td colspan="2" class="title">매입 요청 정보</td></tr>
                    <!-- 요청 구분 : 매입 -->
                    <tr>
                        <td class="sub_title1">요청 구분</td>
                        <td class="sub_content1 bold">매입 요청</td>
                    </tr>
                    <!-- Input : 결제된 건의 거래번호(14 byte) 입력 -->
                    <tr>
                        <td class="sub_title1">KCP 거래번호</td>
                        <td class="sub_input1"><input type="text" name="tno" value="" class="frminput" size="16" maxlength="14"/></td>
                    </tr>
                </table>
                <!-- 매입 요청 정보 입력 테이블 End -->
                ...
                <table width="527" cellspacing="0" cellpadding="0" class="margin_top_20">
                    ...
                    <tr>
                        <td colspan="2" align="center">
                            <input type="image" src="./img/btn_buy.gif" onclick="return jsf__go_mod(this.form);" width="108" height="37" alt="매입을 요청합니다" /></a>
