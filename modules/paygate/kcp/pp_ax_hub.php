<?
	...
	if ( $req_tx == "pay" )
    {
		if( $res_cd == "0000" )
        {
		   ...
		   echo "<script>location.href='".$success_url."';</script>";
			...
			$result = "<script>\n";
			$result .= "openwin = window.open( \"".$alice['paygate_path']."/kcp/proc_win.html\", \"proc_win\", \"width=449, height=209, top=300, left=300\" );";
    ...
    /* ============================================================================== */
		else if ( $res_cd != "0000" )
		{
			...
			$utility->popup_msg_js("서비스를 다시 선택해 주세요.",$return_url."?no=".$no);
...
?>
    ...
    <form name="pay_info" method="post" action="<?php echo $alice['company_path'];?>/success.php">
