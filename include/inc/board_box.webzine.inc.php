...
?>
<div class="image_box"><?php echo $reply_icon; ?>
	<a href="<?=NFE_URL;?>/board/detail.php?board_code=<?=$board_code;?>&code=<?=$code;?>&bo_table=<?=$row['bo_table'];?>&no=<?=$bo_row['wr_no'];?>&page=<?=$_GET['page'];?>"><img src="<?=$get_img;?>" alt=""></a>
</div>
<div class="text_box">
