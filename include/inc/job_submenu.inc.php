...
<div class="navi_cate">
	<a href="#none;" class="prev_btn menu_arrow"><img src="<?=NFE_URL;?>/images/menu_arrow1.png" alt="Өмнөх"></a>
	...
	?>
	<a href="./index.php?code=search" class="item_ <?=$_GET['code']=='search' ? 'active' : '';?>">Дэлгэрэнгүй хайлт </a>
	<?php
	if($design['map_use']) {
	?>
	<a href="./location.php" class="item_ <?=strpos($_SERVER['PHP_SELF'], 'location.php')!==false ? 'active' : '';?>">Байршил хайх</a>
	<?php }?>
	</div>
	<a href="#none;" class="next_btn menu_arrow"><img src="<?=NFE_URL;?>/images/menu_arrow2.png" alt="Дараагийх"></a>
</div>