...
<section class="cont_box detail_con">
	...
	<div class="phone_info info_bx2">
		<div class="phone_inner">
			<dl>
				<dt class="hd"><span><img src="<?=NFE_URL;?>/images/info3.png" alt="전화번호"></span>전화번호</dt>
				<dd class="col1">
					<?=$member['mb_phone'];?>
					<div class="open_info">
						<span><input type="radio" name="mb_phone_view" id="mb_phone_view_1" onClick="netfu_mjob.mb_views('phone', this)" value="1" checked><label for="mb_phone_view_1">공개</label></span>
	...
	<div class="tel_info info_bx2">
		<div class="tel_inner">
			<dl>
				<dt class="hd"><span><img src="<?=NFE_URL;?>/images/info2.png" alt="연락처"></span>휴대폰</dt>
				<dd class="col1 col_w">
					<?=$member['mb_hphone'];?>
					<div class="open_info">
						<span><input type="radio" name="mb_hphone_view" id="mb_hphone_view_1" onClick="netfu_mjob.mb_views('hphone', this)" value="1" checked><label for="mb_hphone_view_1">공개</label></span>
	...
	<div class="mb_info email_info info_bx2">
		<div class="email_inner">
			<dl>
				<dt class="hd"><span><img src="<?=NFE_URL;?>/images/info4.png" alt="이메일"></span>이메일</dt>
				<dd class="col1">
					<?=$member['mb_email'];?>
					<div class="open_info">
						<span><input type="radio" name="mb_email_view" onClick="netfu_mjob.mb_views('email', this)" value="1" id="mb_email_view_1" checked><label for="mb_email_view_1">공개</label></span>
	...
	<div class="home_inner">
		<dl>
			<dt class="hd"><span><img src="<?=NFE_URL;?>/images/info6.png" alt="홈페이지"></span>홈페이지</dt>
				<dd class="col1">
					<?=$member['mb_homepage'];?>
					<div class="open_info">
						<span><input type="radio" name="mb_homepage_view" onClick="netfu_mjob.mb_views('homepage', this)"  value="1" id="mb_homepage_view_1" checked><label for="mb_homepage_view_1">공개</label></span>
	...
	<div class="address_inner">
		<dl>
			<dt class="hd"><span><img src="<?=NFE_URL;?>/images/info5.png" alt="주소"></span>주소</dt>
				<dd class="col1">
					<?=$member['mb_address0'].' '.$member['mb_address1'];?>
					<div class="open_info">
						<span><input type="radio" name="mb_address_view" onClick="netfu_mjob.mb_views('address', this)" value="1" id="mb_address_view_1" checked><label for="mb_address_view_1">공개</label></span>
