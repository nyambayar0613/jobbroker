...
$netfu_auth = new netfu_auth();
	...
	$returnUrl = "http://".$_SERVER['HTTP_HOST']."/modules/okname/ipin_sample/ipin3.php";		// 아이핀 인증을 마치고 돌아올 페이지 주소

	$idpCode   = "V";					// 고정값. KCB기관코드
	$cpCode    = $netfu_auth->auth_id;		// 회원사코드 (테스트인 경우 'P00000000000'를 사용하며 운영시 발급받은 회원사코드를 설정)
