			...
			<div class="row show-grid">
				<div class="span12">
					...
					if (isset($_POST['eventname'])) {
						...
						//$image_content = file_get_contents(dirname(__FILE__) . '/' . $query_string);

						$url = 'http://' . $_SERVER['SERVER_NAME'] . htmlentities($path_info['dirname']) . '/' . $query_string;
						$ch = curl_init();
