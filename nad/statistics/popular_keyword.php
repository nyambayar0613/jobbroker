<?php
		/*
		* /application/nad/statistics/popular_keyword.php
		* @author Harimao
		* @since 2013/10/30
		...
		*/
		...
		##
		# Variables
		$category_list = $search_control->__SearchList('popular');

		##
		# Include view
		if(is_file($alice['self'] . 'views/popular_keyword.html'))
			include_once $alice['self'] . 'views/popular_keyword.html';
		else
			$config->error_info( $alice['self'] . 'views/popular_keyword.html' );
