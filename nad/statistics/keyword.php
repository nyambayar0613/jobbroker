<?php
		/*
		* /application/nad/statistics/keyword.php
		* @author Harimao
		* @since 2013/10/30
		...
		*/
		...
		##
		# Variables
		$get_search = $search_control->get_search();

		##
		# Include view
		if(is_file($alice['self'] . 'views/keyword.html'))
			include_once $alice['self'] . 'views/keyword.html';
		else
			$config->error_info( $alice['self'] . 'views/keyword.html' );
