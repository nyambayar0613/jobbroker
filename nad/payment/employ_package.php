<?php
		/*
		* /application/nad/payment/employ_package.php
		* @author Harimao
		* @since 2015/03/20
		* @last update 2015/04/13
		* @Module v3.5 ( Alice )
		* @Brief :: Employ package
		* @Comment :: 채용공고 패키지 결제 설정
		*/
		...
		$sub_menu_url = "/" . $alice['admin_payment'] . "/employ_package.php";
		...
		##
		# Include view
		if(is_file($alice['self'] . 'views/employ_package.html'))
			include_once $alice['self'] . 'views/employ_package.html';
		else
			$config->error_info( $alice['self'] . 'views/employ_package.html' );
