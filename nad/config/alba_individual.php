<?php
		/*
		* /application/nad/config/alba_individual.php
		* @author Harimao
		* @since 2013/06/25
		* @last update 2013/07/24
		* @Module v3.5 ( Alice )
		* @Brief :: Individual service setting
		* @Comment :: 인재 정보 설정
		*/
		...
		##
		# Include view
		if(is_file($alice['self'] . 'views/alba_individual.html'))
			include_once $alice['self'] . 'views/alba_individual.html';
		else
			$config->error_info( $alice['self'] . 'views/alba_individual.html' );
