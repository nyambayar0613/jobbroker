<?php
		/*
		* /application/nad/config/map.php
		* @author Harimao
		* @since 2013/06/11
		...
		*/
		...
		$sub_menu_url = "/" . $alice['admin_config'] . "/map.php";
		...
		##
		# Include view
		if(is_file($alice['self'] . 'views/map.html'))
			include_once $alice['self'] . 'views/map.html';
		else
			$config->error_info( $alice['self'] . 'views/map.html' );
