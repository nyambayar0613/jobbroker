...
<dl class="wbg" style="padding:0 5px 5px;margin:3px"> 
  <dl class="b nanum fon13 pd7">3-р үе <?php echo $type_arr[$type]['sub_name'];?> Төрөл</dl>
  <table width="100%" cellspacing="1" class="ln sep tf">
    ...
    <tr align="center" class="bg b" height="25">
      ...
      <td class="fon11">Эмхэтгэл</td>
    </tr>

	<tbody id="cate_2_list">
	<tr class="wbg tc" style="height:150px;">
		<td colspan='<?php echo ($is_job)?'4':'3';?>'>2-р үе <?php echo $type_arr[$type]['sub_name'];?>эхлээд сонгоно уу.</td>
	</tr>
	</tbody>
