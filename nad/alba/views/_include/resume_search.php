...
<input type="hidden" name="page_rows" value="<?php echo $page_rows;?>" id="page_rows"/>
	...
	<tr>
		...
		<td class="pdlnb2" colspan="3">
			<label><input name="wr_service[]" type="checkbox" value="main_focus" class="check" id="wr_service_main_focus" <?php echo (@in_array('main_focus',$wr_service))?'checked':'';?>/>포커스</label>
			<label><input name="wr_service[]" type="checkbox" value="main_focus_gold" class="check" id="wr_service_main_focus_gold" <?php echo (@in_array('main_focus_gold',$wr_service))?'checked':'';?>/>포커스골드</label>
