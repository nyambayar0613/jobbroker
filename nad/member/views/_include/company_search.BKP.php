...
<input type="hidden" name="page_rows" value="<?php echo $page_rows;?>" id="page_rows"/>
	...
	<tr>
		<td class="ctlt">Байгууллагын ангилал</td>
		<td class="pdlnb2">
	...
	<dl class="tc pd7 wbg">
		<select name="search_field" class="s23" id="search_field">
			...
			<option value="mb_ceo_name" <?php echo ($_GET['search_field']=='mb_ceo_name')?'selected':'';?>>Хариуцсан хүний нэр</option>
			<option value="mb_company_name" <?php echo ($_GET['search_field']=='mb_company_name')?'selected':'';?>>Байгууллагын нэр</option>
			<option value="mb_biz_no" <?php echo ($_GET['search_field']=='mb_biz_no')?'selected':'';?>>Компанийн бүртгэлийн дугаар</option>
			<option value="mb_biz_phone" <?php echo ($_GET['search_field']=='mb_biz_phone')?'selected':'';?>>Утасны дугаар</option>
			<option value="mb_biz_hphone" <?php echo ($_GET['search_field']=='mb_biz_hphone')?'selected':'';?>>Гар утасны дугаар</option>
			<option value="mb_biz_fax" <?php echo ($_GET['search_field']=='mb_biz_fax')?'selected':'';?>>Факсын дугаар</option>
			<option value="mb_biz_email" <?php echo ($_GET['search_field']=='mb_biz_email')?'selected':'';?>>И-мэйл</option>
		</select>
