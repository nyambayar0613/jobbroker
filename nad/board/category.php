<?php
		/*
		* /application/nad/board/category.php
		* @author Harimao
		* @since 2013/05/28
		...
		*/
		...
		$type_arr = array(
			'notice' => array('name' => $menu[$tmp_menu]['menus'][3]['sub_menu'][0]['name'], 'code' => $menu[$tmp_menu]['menus'][3]['sub_menu'][0]['code']),
			'on2on' => array('name' => $menu[$tmp_menu]['menus'][3]['sub_menu'][1]['name'], 'code' => $menu[$tmp_menu]['menus'][3]['sub_menu'][1]['code']),
			'advert' => array('name' => $menu[$tmp_menu]['menus'][3]['sub_menu'][2]['name'], 'code' => $menu[$tmp_menu]['menus'][3]['sub_menu'][2]['code']),
			'concert' => array('name' => $menu[$tmp_menu]['menus'][3]['sub_menu'][3]['name'], 'code' => $menu[$tmp_menu]['menus'][3]['sub_menu'][3]['code']),
				/*'board_reason' => array('name' => $menu[$tmp_menu]['menus'][3]['sub_menu'][4]['name'], 'code' => $menu[$tmp_menu]['menus'][3]['sub_menu'][4]['code']),
