<?php
		/*
		* /application/nad/board/concert.php
		* @author Harimao
		* @since 2012/07/16
		...
		*/
		...
		$sub_menu_url = "/" . $alice['admin_board'] . "/concert.php";
		...
		##
		# Include view
		if(is_file($alice['self'] . 'views/concert.html'))
			include_once $alice['self'] . 'views/concert.html';
		else
			$config->error_info( $alice['self'] . 'views/concert.html' );
